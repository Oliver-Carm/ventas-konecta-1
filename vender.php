...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Ventas-K</span>
    </a>
  ...
  <div class="content-wrapper">
	...
	?>
		...
		?>
			<div class="alert alert-warning">
				<strong>Error:</strong> El producto que buscas no existe en el inventario
			</div>
		<?php
		} else if ($_GET["status"] === "5") {
		?>
			<div class="alert alert-danger">
				<strong>Error: </strong>Producto agotado.
			</div>
		<?php
		} else {
		?>
	...
	<form action="terminarVenta.php" method="POST">
		...
		<button type="submit" class="btn btn-success">Pagar venta</button>
